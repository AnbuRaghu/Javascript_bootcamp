class App {
  constructor() {
    this.notes = JSON.parse(localStorage.getItem('notes')) || [];// getting local storage
    this.title = "";
    this.text = "";
    this.id = "";
  ...
  render() {// instead of repeating this two methods, wwe just vreate a function and call it
    this.saveNotes();
    this.displayNotes();  
  }
  
  saveNotes() {
    localStorage.setItem('notes', JSON.stringify(this.notes))  // setting notes to local storage
  }
